...
public class CarmenMaterialisticDialogue : MonoBehaviour
{
    //Game Manager
    ...
    private void DialogueLine6()
    {
        ...
        hasEndedTyping = false;
        spiritNameText.text = gameManager_Script.playerName;
        texToToWrite = "You were in a luxurious home, looking at yourself in the mirror, on your neck and ears, diamonds and gold.";
        StartCoroutine(TypeText(texToToWrite));
        canTalk = false;
    }
    ...
    private void DialogueLine7()
    {
        ...
        hasEndedTyping = false;
        spiritNameText.text = gameManager_Script.playerName;
        texToToWrite = "Sparkling, and beautiful, you just bought them for yourself, just because you could.";
        StartCoroutine(TypeText(texToToWrite));
        canTalk = false;
    }
    ...
    private void DialogueLine15()
    {
        ...
        button2AnswerText.text = "(Materialistic) I understand the joy of giving oneself a little gift.";

...
public class BrunoGeniusDialogue : MonoBehaviour
{
    //Game Manager
...
case 101:
   ...
   break;*/
    ...
    private void DialogueLine6()
    {
        ...
        hasEndedTyping = false;
        spiritNameText.text = gameManager_Script.playerName;
        texToToWrite = "You were in a science lab, looked like a university, and apparently having fun in chemistry class.";
        StartCoroutine(TypeText(texToToWrite));
        canTalk = false;
    }
    ...
    private void DialogueLine7()
    {
        ...
        hasEndedTyping = false;
        spiritNameText.text = gameManager_Script.playerName;
        texToToWrite = "And you were very good at it too!";
        StartCoroutine(TypeText(texToToWrite));
        canTalk = false;
    }
    ...
    private void DialogueLine15()
    {
        ...
        button2AnswerText.text = "(Genius) I see you love knowledge.";

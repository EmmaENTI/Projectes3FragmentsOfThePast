...
public class BrunoGeekDialogue : MonoBehaviour
{
    //Game Manager
...
case 101:
   ...
   break;*/
    ...
    private void DialogueLine6()
    {
        ...
        hasEndedTyping = false;
        spiritNameText.text = gameManager_Script.playerName;
        texToToWrite = "You were playing Switch on a cozy room, snacks on a side and very immersed in a videogame!";
        StartCoroutine(TypeText(texToToWrite));
        canTalk = false;
    }
    ...
    private void DialogueLine7()
    {
        ...
        hasEndedTyping = false;
        spiritNameText.text = gameManager_Script.playerName;
        texToToWrite = "You were a total geek.";
        StartCoroutine(TypeText(texToToWrite));
        canTalk = false;
    }
    ...
    private void DialogueLine15()
    {
        ...
        button2AnswerText.text = "(Geek) I like videogames and geeky stuff too!";
